		...
		<div class="container slide2">
	  		...
	  		<div class="row">
	  			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column">
	  				...
	  				This is online portal for library management. This website is developed by 
                                        Pillai Ganesh Mohan. This website is for Pillai HOC Polytechnic. Students are 
                                        always welcomed to use this website to access books.
	  			...
	  			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column">
	  				...
	  				Students are always free to contact us regarding any issues related to online
                                        library management as we provide 24/7 support.
	  			</div>
	  			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column">
	  				<div class="page-header col-lg-offset-1">
	  				<h2>Why Us?</h2>
	  			</div>
	  				Due to this website, students are always free to access any books from anywhere
                                        at any time. We are always opened for any suggestion regarding any new books.
	  			</div>
	  		</div>
		</div>
